  ...
  func testCorePublicSurfaceStaysIntentional() throws {
    ...
    XCTAssertEqual(
      ...
      [
        ...
        "Sources/AirPortUtilityCore/ContentView.swift:public enum SidebarDestination: String, CaseIterable, Identifiable, Hashable {",
        ...
        "Sources/AirPortUtilityCore/ContentView.swift:public var id: Self { self }",
